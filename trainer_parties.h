...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ATTRACT, MOVE_RAZOR_WING, MOVE_MOONBLAST, MOVE_WATER_PULSE}
    },
    {
    .iv = 100,
    .lvl = 52,
...
static const struct TrainerMonItemCustomMoves sParty_Tumblrita[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_CHAOS_DUNK, MOVE_LIQUIDATION, MOVE_SCARY_FACE, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 62,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_DRAINING_KISS, MOVE_DESTINY_BOND}
    },
    {
    .iv = 250,
    .lvl = 63,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_FLAMETHROWER, MOVE_WORK_UP}
    },
    {
    .iv = 250,
    .lvl = 64,
...
static const struct TrainerMonItemCustomMoves sParty_Floyd[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_PSYCHIC_FANGS, MOVE_AQUA_JET}
    },
    {
    .iv = 250,
    .lvl = 67,
...
static const struct TrainerMonItemCustomMoves sParty_Joy[] = {
    ...
    .abilityNums = 2,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_CHAOS_DUNK, MOVE_X_SCISSOR}
    },
    {
    .iv = 250,
    .lvl = 67,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_ICE_FANG}
    },
    {
    .iv = 250,
    .lvl = 68,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_SHADOW_BALL, MOVE_THUNDERBOLT, MOVE_PIN_MISSILE, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 69,
...
static const struct TrainerMonItemCustomMoves sParty_Snoop[] = {
    ...
    .abilityNums = 2,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_GLARE, MOVE_SOLAR_BEAM, MOVE_PROTECT, MOVE_GUNK_SHOT}
    },
    {
    .iv = 250,
    .lvl = 66,
    ...
    .abilityNums = 2,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_SURF, MOVE_SEED_FLARE, MOVE_SYNTHESIS, MOVE_SPORE}
    },
    {
    .iv = 250,
    .lvl = 67,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_LEAF_STORM, MOVE_EARTH_POWER, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 69,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_DRACO_METEOR, MOVE_FLY, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 70,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .moves = {MOVE_HOLY_DUTY, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 200,
    .lvl = 32,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_SPORE, MOVE_THUNDERBOLT, MOVE_SURF, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 250,
    .lvl = 33,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_CHAOS_DUNK, MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_FLAMETHROWER}
    },
    {
    .iv = 250,
    .lvl = 53,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_CHAOS_DUNK, MOVE_PSYCHIC, MOVE_SPORE, MOVE_LIGHT_SCREEN}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cynthia[] = {
    ...
    .heldItem = ITEM_LIFE_ORB,
    .abilityNums = 0,
    .moves = {MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_PIN_MISSILE, MOVE_ICE_SHARD}
    },
    {
    .iv = 255,
    .lvl = 74,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    .lvl = 46,
    .species = SPECIES_MIGHTYENA,
    .moves = {MOVE_CRUNCH, MOVE_TAKE_DOWN, MOVE_SCARY_FACE, MOVE_TAKE_DOWN}
    },
    ...
    .lvl = 47,
    .species = SPECIES_CROBAT,
    .moves = {MOVE_AIR_CUTTER, MOVE_POISON_JAB, MOVE_CONFUSE_RAY, MOVE_BITE}
    ...
    .lvl = 48,
    .species = SPECIES_LIZAKBAR,
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_NASTY_PLOT, MOVE_EXPLOSION}
    },
    ...
    .lvl = 49,
    .species = SPECIES_HYLETRACK,
    .moves = {MOVE_HEAT_CRASH, MOVE_SHARPEN, MOVE_FLASH_CANNON, MOVE_SPEED_WEED}
    },
    {
    .iv = 150,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .heldItem = ITEM_CHARCOAL,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_SAND_ATTACK, MOVE_MACH_PUNCH, MOVE_BULK_UP}
    },
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .heldItem = ITEM_WATMEL_BERRY,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_SURF, MOVE_TRIGGER, MOVE_SLACK_OFF, MOVE_CRUNCH}
    },
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .abilityNums = 0,
    .evs = {0, 0, 129, 0, 129, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_DARK_PULSE, MOVE_NASTY_PLOT, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 100,

...
$(OBJEVENTGFXDIR)/people/gym_leaders/ned.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/people/gym_leaders/bender.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/elite_four/snoop.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/elite_four/joy.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/elite_four/captain_floyd.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/elite_four/tumblrita.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/gym_leaders/new_flannery.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

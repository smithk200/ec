...
#define FLAG_CHAMP    0x20 // Unused Flag
#define FLAG_BOUGHT_ARABOMB    0x21 // Unused Flag
#define FLAG_LAVARIDGE_PUZZLE_COMPLETE   0x22 // Unused Flag
#define FLAG_FORTREE_PUZZLE_COMPLETE    0x23 // Unused Flag
#define FLAG_MOSSDEEP_PUZZLE_COMPLETE   0x24 // Unused Flag
#define FLAG_SOOTOPOLIS_PUZZLE_COMPLETE   0x25 // Unused Flag
#define FLAG_FORTREE_GYM_NPC    0x26 // Unused Flag

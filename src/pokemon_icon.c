...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_BLISSEY_EV_TRAIN] = gMonIcon_Blissey,
    ...
    [SPECIES_FISHNISM] = gMonIcon_Fishnism,
    [SPECIES_SJWHALE] = gMonIcon_Sjwhale,
    [SPECIES_BONGECKO] = gMonIcon_Bongecko,
    [SPECIES_MARIGUANA] = gMonIcon_Mariguana,
    [SPECIES_MARLEYZARD] = gMonIcon_Marleyzard,
    [SPECIES_CHEZETTA] = gMonIcon_Chezetta,
    [SPECIES_MOZZAMAZEL] = gMonIcon_Mozzamazel,
    [SPECIES_SINGLETS] = gMonIcon_Singlets,
    [SPECIES_DUBUS] = gMonIcon_Dubus,
    [SPECIES_TRIPSIUS] = gMonIcon_Tripsius,
    [SPECIES_SAPLEAF] = gMonIcon_Sapleaf,
    [SPECIES_IGNUT] = gMonIcon_Ignut,
    [SPECIES_PHANTASH] = gMonIcon_Phantash,
    [SPECIES_SMOGAROBEN] = gMonIcon_Smogaroben,
    [SPECIES_SMOXILON] = gMonIcon_Smoxilon,
    [SPECIES_SPRUCIFIX] = gMonIcon_Sprucifix,
    [SPECIES_CHARAGON] = gMonIcon_Charagon,
    [SPECIES_HYLETRACK] = gMonIcon_Hyletrack,
    [SPECIES_POLLEFIN] = gMonIcon_Pollefin,
    [SPECIES_FLORIGRACE] = gMonIcon_Florigrace,
    [SPECIES_ARABOMB] = gMonIcon_Arabomb,
    [SPECIES_IGUALLAH] = gMonIcon_Iguallah,
    [SPECIES_LIZAKBAR] = gMonIcon_Lizakbar,
    [SPECIES_CAROLINE] = gMonIcon_Caroline,
    [SPECIES_GLASSHOT] = gMonIcon_Glasshot,
    [SPECIES_GLASSANNON] = gMonIcon_Glassannon,
    [SPECIES_MOTHERFUCK] = gMonIcon_Motherfuck,
    [SPECIES_LARVADES] = gMonIcon_Larvades,
    [SPECIES_PROBOSKITO] = gMonIcon_Proboskito,
    [SPECIES_VENOWATT] = gMonIcon_Venowatt,
    [SPECIES_ADESIGN] = gMonIcon_Adesign,
    [SPECIES_BACUB] = gMonIcon_Bacub,
    [SPECIES_URSWINE] = gMonIcon_Urswine,
    [SPECIES_TRICIENT] = gMonIcon_Tricient,
    [SPECIES_TRICILLION] = gMonIcon_Tricillion,
    [SPECIES_CLOVENIX] = gMonIcon_Clovenix,
    [SPECIES_INBITWEEN] = gMonIcon_Inbitween,
    [SPECIES_GEIGH] = gMonIcon_Geigh,
    [SPECIES_DRAGKING] = gMonIcon_Dragking,
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_IGNUT] = 0,
    [SPECIES_PHANTASH] = 0,
    [SPECIES_SMOGAROBEN] = 2,
    [SPECIES_SMOXILON] = 2,
    [SPECIES_SPRUCIFIX] = 1,
    [SPECIES_CHARAGON] = 0,
    [SPECIES_HYLETRACK] = 0,
    [SPECIES_POLLEFIN] = 0,
    [SPECIES_FLORIGRACE] = 0,
    [SPECIES_ARABOMB] = 0,
    [SPECIES_IGUALLAH] = 0,
    [SPECIES_LIZAKBAR] = 1,
    [SPECIES_CAROLINE] = 5,
    [SPECIES_GLASSHOT] = 0,
    [SPECIES_GLASSANNON] = 0,
    [SPECIES_MOTHERFUCK] = 0,
    [SPECIES_LARVADES] = 0,
    [SPECIES_PROBOSKITO] = 0,
    [SPECIES_VENOWATT] = 0,
    [SPECIES_ADESIGN] = 0,
    [SPECIES_BACUB] = 0,
    [SPECIES_URSWINE] = 0,
    [SPECIES_TRICIENT] = 0,
    [SPECIES_TRICILLION] = 0,
    [SPECIES_CLOVENIX] = 1,
    [SPECIES_INBITWEEN] = 0,
    [SPECIES_GEIGH] = 0,
    [SPECIES_DRAGKING] = 0,

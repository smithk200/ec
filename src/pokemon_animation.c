...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_FISHNISM]     = BACK_ANIM_H_SLIDE,
    [SPECIES_SJWHALE]     = BACK_ANIM_H_SLIDE,
    [SPECIES_BONGECKO]     = BACK_ANIM_H_SLIDE,
    [SPECIES_MARIGUANA]     = BACK_ANIM_H_SLIDE,
    [SPECIES_MARLEYZARD]     = BACK_ANIM_H_SLIDE,
    [SPECIES_CHEZETTA]     = BACK_ANIM_H_SLIDE,
    [SPECIES_MOZZAMAZEL]     = BACK_ANIM_H_SLIDE,
    [SPECIES_SINGLETS]     = BACK_ANIM_H_SLIDE,
    [SPECIES_DUBUS]     = BACK_ANIM_H_SLIDE,
    [SPECIES_TRIPSIUS]     = BACK_ANIM_H_SLIDE,
    [SPECIES_SAPLEAF]     = BACK_ANIM_H_SLIDE,
    [SPECIES_IGNUT]     = BACK_ANIM_H_SLIDE,
    [SPECIES_PHANTASH]     = BACK_ANIM_H_SLIDE,
    [SPECIES_SMOGAROBEN]     = BACK_ANIM_H_SLIDE,
    [SPECIES_SMOXILON]     = BACK_ANIM_H_SLIDE,
    [SPECIES_SPRUCIFIX]     = BACK_ANIM_H_SLIDE,
    [SPECIES_CHARAGON]     = BACK_ANIM_H_SLIDE,
    [SPECIES_HYLETRACK]     = BACK_ANIM_H_SLIDE,
    [SPECIES_POLLEFIN]     = BACK_ANIM_H_SLIDE,
    [SPECIES_FLORIGRACE]     = BACK_ANIM_H_SLIDE,
    [SPECIES_ARABOMB]     = BACK_ANIM_H_SLIDE,
    [SPECIES_IGUALLAH]     = BACK_ANIM_H_SLIDE,
    [SPECIES_LIZAKBAR]     = BACK_ANIM_H_SLIDE,
    [SPECIES_CAROLINE]     = BACK_ANIM_H_SLIDE,
    [SPECIES_GLASSHOT]     = BACK_ANIM_H_SLIDE,
    [SPECIES_GLASSANNON]     = BACK_ANIM_H_SLIDE,
    [SPECIES_MOTHERFUCK]     = BACK_ANIM_H_SLIDE,
    [SPECIES_LARVADES]     = BACK_ANIM_H_SLIDE,
    [SPECIES_PROBOSKITO]     = BACK_ANIM_H_SLIDE,
    [SPECIES_VENOWATT]     = BACK_ANIM_H_SLIDE,
    [SPECIES_ADESIGN]     = BACK_ANIM_H_SLIDE,
    [SPECIES_BACUB]     = BACK_ANIM_H_SLIDE,
    [SPECIES_URSWINE]     = BACK_ANIM_H_SLIDE,
    [SPECIES_TRICIENT]     = BACK_ANIM_H_SLIDE,
    [SPECIES_TRICILLION]     = BACK_ANIM_H_SLIDE,
    [SPECIES_CLOVENIX]     = BACK_ANIM_H_SLIDE,
    [SPECIES_INBITWEEN]     = BACK_ANIM_H_SLIDE,
    [SPECIES_GEIGH]     = BACK_ANIM_H_SLIDE,
    [SPECIES_DRAGKING]     = BACK_ANIM_H_SLIDE,
};

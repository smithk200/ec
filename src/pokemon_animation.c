...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_FISHNISM]     = BACK_ANIM_NONE,
    [SPECIES_SJWHALE]     = BACK_ANIM_NONE,
    [SPECIES_BONGECKO]     = BACK_ANIM_NONE,
    [SPECIES_MARIGUANA]     = BACK_ANIM_NONE,
    [SPECIES_MARLEYZARD]     = BACK_ANIM_NONE,
    [SPECIES_CHEZETTA]     = BACK_ANIM_NONE,
    [SPECIES_MOZZAMAZEL]     = BACK_ANIM_NONE,
    [SPECIES_SINGLETS]     = BACK_ANIM_NONE,
    [SPECIES_DUBUS]     = BACK_ANIM_NONE,
    [SPECIES_TRIPSIUS]     = BACK_ANIM_NONE,
    [SPECIES_SAPLEAF]     = BACK_ANIM_NONE,
    [SPECIES_IGNUT]     = BACK_ANIM_NONE,
    [SPECIES_PHANTASH]     = BACK_ANIM_NONE,
    [SPECIES_SMOGAROBEN]     = BACK_ANIM_NONE,
    [SPECIES_SMOXILON]     = BACK_ANIM_NONE,
    [SPECIES_SPRUCIFIX]     = BACK_ANIM_NONE,
    [SPECIES_CHARAGON]     = BACK_ANIM_NONE,
    [SPECIES_HYLETRACK]     = BACK_ANIM_NONE,
    [SPECIES_POLLEFIN]     = BACK_ANIM_NONE,
    [SPECIES_FLORIGRACE]     = BACK_ANIM_NONE,
    [SPECIES_ARABOMB]     = BACK_ANIM_NONE,
    [SPECIES_IGUALLAH]     = BACK_ANIM_NONE,
    [SPECIES_LIZAKBAR]     = BACK_ANIM_NONE,
    [SPECIES_CAROLINE]     = BACK_ANIM_NONE,
    [SPECIES_GLASSHOT]     = BACK_ANIM_NONE,
    [SPECIES_GLASSANNON]     = BACK_ANIM_NONE,
    [SPECIES_MOTHERFUCK]     = BACK_ANIM_NONE,
    [SPECIES_LARVADES]     = BACK_ANIM_NONE,
    [SPECIES_PROBOSKITO]     = BACK_ANIM_NONE,
    [SPECIES_VENOWATT]     = BACK_ANIM_NONE,
    [SPECIES_ADESIGN]     = BACK_ANIM_NONE,
};

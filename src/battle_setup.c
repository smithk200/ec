...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_TONY] = REMATCH(TRAINER_TONY_2, TRAINER_TONY_2, TRAINER_TONY_3, TRAINER_TONY_4, TRAINER_TONY_5, ROUTE107),
    ...
    [REMATCH_MARIA] = REMATCH(TRAINER_MARIA_1, TRAINER_MARIA_2, TRAINER_MARIA_2, TRAINER_MARIA_2, TRAINER_MARIA_2, ROUTE117),
    ...
    [REMATCH_FLANNERY] = REMATCH(TRAINER_MOLLY_1, TRAINER_MOLLY_2, TRAINER_FLANNERY_3, TRAINER_FLANNERY_4, TRAINER_FLANNERY_5, LAVARIDGE_TOWN),
    ...
    [REMATCH_WINONA] = REMATCH(TRAINER_NED_1, TRAINER_NED_2, TRAINER_WINONA_3, TRAINER_WINONA_4, TRAINER_WINONA_5, FORTREE_CITY),
    [REMATCH_TATE_AND_LIZA] = REMATCH(TRAINER_TATE, TRAINER_TATE_2, TRAINER_TATE_AND_LIZA_3, TRAINER_TATE_AND_LIZA_4, TRAINER_TATE_AND_LIZA_5, MOSSDEEP_CITY),
    [REMATCH_JUAN] = REMATCH(TRAINER_BENDER_1, TRAINER_JUAN_2, TRAINER_JUAN_3, TRAINER_JUAN_4, TRAINER_JUAN_5, SOOTOPOLIS_CITY),
    [REMATCH_SIDNEY] = REMATCH(TRAINER_TUMBLRITA, TRAINER_TUMBLRITA, TRAINER_TUMBLRITA, TRAINER_TUMBLRITA, TRAINER_TUMBLRITA, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_CAPTAIN_FLOYD, TRAINER_CAPTAIN_FLOYD, TRAINER_CAPTAIN_FLOYD, TRAINER_CAPTAIN_FLOYD, TRAINER_CAPTAIN_FLOYD, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_JOY, TRAINER_JOY, TRAINER_JOY, TRAINER_JOY, TRAINER_JOY, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_SNOOP, TRAINER_SNOOP, TRAINER_SNOOP, TRAINER_SNOOP, TRAINER_SNOOP, EVER_GRANDE_CITY),
...
void PlayTrainerEncounterMusic(void)
{
        ...
        && sTrainerBattleMode != TRAINER_BATTLE_CONTINUE_SCRIPT_DOUBLE_NO_MUSIC)
    {
        ...
        case TRAINER_ENCOUNTER_MUSIC_RICH:
            ...
            break;
        case TRAINER_ENOUNTER_MUSIC_GYM_LEADER:
            music = MUS_LEADER_ENCOUNTER;
            break;
        default:

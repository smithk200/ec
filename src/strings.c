...
const u8 gText_DadsAdvice[] = _("You can't use that, numbskull!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_MailCantBeStored[] = _("Mail can't be stored, idiot!");
...
const u8 gText_MrStoneMatchCallName[] = _("MR. BIDEN");

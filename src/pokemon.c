...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    SPECIES_TO_NATIONAL(FISHNISM),
    SPECIES_TO_NATIONAL(SJWHALE),
    SPECIES_TO_NATIONAL(BONGECKO),
    SPECIES_TO_NATIONAL(MARIGUANA),
    SPECIES_TO_NATIONAL(MARLEYZARD),
    SPECIES_TO_NATIONAL(CHEZETTA),
    SPECIES_TO_NATIONAL(MOZZAMAZEL),
    SPECIES_TO_NATIONAL(SINGLETS),
    SPECIES_TO_NATIONAL(DUBUS),
    SPECIES_TO_NATIONAL(TRIPSIUS),
    SPECIES_TO_NATIONAL(SAPLEAF),
    SPECIES_TO_NATIONAL(IGNUT),
    SPECIES_TO_NATIONAL(PHANTASH),
    SPECIES_TO_NATIONAL(SMOGAROBEN),
    SPECIES_TO_NATIONAL(SMOXILON),
    SPECIES_TO_NATIONAL(SPRUCIFIX),
    SPECIES_TO_NATIONAL(CHARAGON),
    SPECIES_TO_NATIONAL(HYLETRACK),
    SPECIES_TO_NATIONAL(POLLEFIN),
    SPECIES_TO_NATIONAL(FLORIGRACE),
    SPECIES_TO_NATIONAL(ARABOMB),
    SPECIES_TO_NATIONAL(IGUALLAH),
    SPECIES_TO_NATIONAL(LIZAKBAR),
    SPECIES_TO_NATIONAL(CAROLINE),
    SPECIES_TO_NATIONAL(GLASSHOT),
    SPECIES_TO_NATIONAL(GLASSANNON),
    SPECIES_TO_NATIONAL(MOTHERFUCK),
    SPECIES_TO_NATIONAL(LARVADES),
    SPECIES_TO_NATIONAL(PROBOSKITO),
    SPECIES_TO_NATIONAL(VENOWATT),
    SPECIES_TO_NATIONAL(ADESIGN),
    SPECIES_TO_NATIONAL(BACUB),
    SPECIES_TO_NATIONAL(URSWINE),
    SPECIES_TO_NATIONAL(TRICIENT),
    SPECIES_TO_NATIONAL(TRICILLION),
    SPECIES_TO_NATIONAL(CLOVENIX),
    SPECIES_TO_NATIONAL(INBITWEEN),
    SPECIES_TO_NATIONAL(GEIGH),
    SPECIES_TO_NATIONAL(DRAGKING),
...
#endif
{
    ...
    [SPECIES_FISHNISM - 1]    = ANIM_H_SLIDE,
    [SPECIES_SJWHALE - 1]    = ANIM_H_SLIDE,
    [SPECIES_BONGECKO - 1]    = ANIM_H_SLIDE,
    [SPECIES_MARIGUANA - 1]    = ANIM_H_SLIDE,
    [SPECIES_MARLEYZARD - 1]    = ANIM_H_SLIDE,
    [SPECIES_CHEZETTA - 1]    = ANIM_H_SLIDE,
    [SPECIES_MOZZAMAZEL - 1]    = ANIM_H_SLIDE,
    [SPECIES_SINGLETS - 1]    = ANIM_H_SLIDE,
    [SPECIES_DUBUS - 1]    = ANIM_H_SLIDE,
    [SPECIES_TRIPSIUS - 1]    = ANIM_H_SLIDE,
    [SPECIES_SAPLEAF - 1]    = ANIM_H_SLIDE,
    [SPECIES_IGNUT - 1]    = ANIM_H_SLIDE,
    [SPECIES_PHANTASH - 1]    = ANIM_H_SLIDE,
    [SPECIES_SMOGAROBEN - 1]    = ANIM_H_SLIDE,
    [SPECIES_SMOXILON - 1]    = ANIM_H_SLIDE,
    [SPECIES_SPRUCIFIX - 1]    = ANIM_H_SLIDE,
    [SPECIES_CHARAGON - 1]    = ANIM_H_SLIDE,
    [SPECIES_HYLETRACK - 1]    = ANIM_H_SLIDE,
    [SPECIES_POLLEFIN - 1]    = ANIM_H_SLIDE,
    [SPECIES_FLORIGRACE - 1]    = ANIM_H_SLIDE,
    [SPECIES_ARABOMB - 1]    = ANIM_H_SLIDE,
    [SPECIES_IGUALLAH - 1]    = ANIM_H_SLIDE,
    [SPECIES_LIZAKBAR - 1]    = ANIM_H_SLIDE,
    [SPECIES_CAROLINE - 1]    = ANIM_H_SLIDE,
    [SPECIES_GLASSHOT - 1]    = ANIM_H_SLIDE,
    [SPECIES_GLASSANNON - 1]    = ANIM_H_SLIDE,
    [SPECIES_MOTHERFUCK - 1]    = ANIM_H_SLIDE,
    [SPECIES_LARVADES - 1]    = ANIM_H_SLIDE,
    [SPECIES_PROBOSKITO - 1]    = ANIM_H_SLIDE,
    [SPECIES_VENOWATT - 1]    = ANIM_H_SLIDE,
    [SPECIES_ADESIGN - 1]    = ANIM_H_SLIDE,
    [SPECIES_BACUB - 1]    = ANIM_H_SLIDE,
    [SPECIES_URSWINE - 1]    = ANIM_H_SLIDE,
    [SPECIES_TRICIENT - 1]    = ANIM_H_SLIDE,
    [SPECIES_TRICILLION - 1]    = ANIM_H_SLIDE,
    [SPECIES_CLOVENIX - 1]    = ANIM_H_SLIDE,
    [SPECIES_INBITWEEN - 1]    = ANIM_H_SLIDE,
    [SPECIES_GEIGH - 1]    = ANIM_H_SLIDE,
    [SPECIES_DRAGKING - 1]    = ANIM_H_SLIDE,
...
u8 CanLearnTeachableMove(u16 species, u16 move)
{
    ...
    else if (species == SPECIES_MEW || species == SPECIES_ADESIGN)
    {
        switch (move)
        {
        case MOVE_BADDY_BAD:

...
static const s16 sMugshotsOpponentRotationScales[TRAINER_PIC_COUNT] =
{
    ...
    [TRAINER_PIC_LEADER_NED]       =      0x200,
    [TRAINER_PIC_LEADER_BENDER ]         = 0x200,
    [TRAINER_PIC_ELITE_FOUR_SNOOP]         = 0x200,
    [TRAINER_PIC_ELITE_FOUR_JOY]           = 0x200,
    [TRAINER_PIC_ELITE_FOUR_TUMBLRITA]      = 0x200,
    ...
    [TRAINER_PIC_TATE] = 0x200,
    [TRAINER_PIC_LIZA] = 0x200,
    [TRAINER_PIC_LEADER_BILL_NYE] = 0x200,               
};
...
static const s16 sMugshotsOpponentCoords[TRAINER_PIC_COUNT][2] =
{
    ...
    [TRAINER_PIC_LEADER_NED]       =      { 0,  0},
    [TRAINER_PIC_LEADER_BENDER ]         = { 0,  0},
    [TRAINER_PIC_ELITE_FOUR_SNOOP]         = { 0,  0},
    [TRAINER_PIC_ELITE_FOUR_JOY]           = { 0,  0},
    [TRAINER_PIC_ELITE_FOUR_TUMBLRITA]      = { 0,  0},
    [TRAINER_PIC_ELITE_FOUR_CAPTAIN_FLOYD] = { 0,  0},
    [TRAINER_PIC_LEADER_NEW_FLANNERY] = { 0,  0},
    [TRAINER_PIC_FRY] = { 0,  0},
    [TRAINER_PIC_CYNTHIA] = { 0,  0},
    [TRAINER_PIC_FEMINIST] = { 0,  0},
    [TRAINER_PIC_SUPER_NERD] = { 0,  0},
    [TRAINER_PIC_TATE] = { 0,  0},
    [TRAINER_PIC_LIZA] = { 0,  0},
    [TRAINER_PIC_LEADER_BILL_NYE] = { 0,  0},
};

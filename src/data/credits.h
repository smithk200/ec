...
static const u8 sCreditsText_PkmnEmeraldVersion[]             = _("Pokémon Emerald Clover");
...
static const u8 sCreditsText_SatoshiTajiri[]                  = _("smithj200"); //executive director
static const u8 sCreditsText_JunichiMasuda[]                  = _("Junichi Masuda");
static const u8 sCreditsText_KenSugimori[]                    = _("Ken Sugimori");
static const u8 sCreditsText_ShigekiMorimoto[]                = _("smithj200");
...
static const u8 sCreditsText_SatoruIwata[]                    = _("smithj200");

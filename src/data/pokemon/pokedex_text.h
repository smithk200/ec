...
const u8 gFishnismPokedexText[] = _(
    ...
    "take rights to their territory. They are often \n"
    "seen destroying things made by males.");
...
const u8 gBongeckoPokedexText[] = _(
    "Its tail can emit a smoke that it gets high from.\n"
    "Other Pokémon and people can also get high from\n"
    "inhaling it too.");
const u8 gMariguanaPokedexText[] = _(
    "With a bad case of the munchies, it'll eat anything it\n"
    "finds. It is prone to get distracted, even during battle.");
const u8 gMarleyzardPokedexText[] = _(
    "It is always high and moves erratically.\n"
    "It is capable of flight on its weed wings as\n"
...
const u8 gSingletsPokedexText[] = _(
    "The numbers on Singlets are said to have never.\n"
    "matched. It concentrates its psychic power on\n"
    "achieving this.");
const u8 gDubusPokedexText[] = _(
    "Singlets gather in droves to witness the evolution of a\n"
    "Dubus. They are said to be a sign of good fortune.");
const u8 gTripsiusPokedexText[] = _(
    "Tripsius are a very rare sight. They are recognized by\n"
    "Singlets and Dubus colonies as ultimate authority.");
const u8 gSapleafPokedexText[] = _(
    "Sapleaf love sunbathing in open fields, ignoring their\n" 
    "elders' advice about the dangers of sunbathing too\n"
    "long…");
const u8 gIgnutPokedexText[] = _(
    "Overexposure from the sun caused its body to burst into flames.\n"
    "It screams in agony as the undying fire slowly\n"
    "kills it.");
const u8 gPhantashPokedexText[] = _(
    "TPhantash is between life and death. It tries to warn\n"
    "Sapleaf of their fate but none of them heed its warning.");
const u8 gSmogarobenPokedexText[] = _(
    "This Pokémon is highly competitive, although it only\n"
    "likes to use certain moves. If it loses, it will cry for days.");
const u8 gSmoxilonPokedexText[] = _(
    "Smoxilon attacks are powerful, but easy to predict.\n"
    "It's a highly loved Pokémon among kids and Smogoons.");
const u8 gSprucifixPokedexText[] = _(
    "I am thirsty.");
const u8 gCharagonPokedexText[] = _(
	"It exhales smoke at high temperatures while it moves.\n"
    "It can combine with others of its kind to form a long line.");
const u8 gHyletrackPokedexText[] = _(
	"Hyletrack are known to be attracted to those that are hyped.\n"
    "Legends say just seeing one will get you hyped too.");
const u8 gPollefinPokedexText[] = _(
	"This appeared in Pokemon Clover");
const u8 gFlorigracePokedexText[] = _(
	"This appeared in Pokemon Clover");
const u8 gArabombPokedexText[] = _(
	"If Arabomb feels happy, it runs in circles until it explodes.\n"
    "When it rains, it likes to stay under the sand.");
const u8 gIguallahPokedexText[] = _(
	"It bombs caves to force its prey out.\n"
    "If an enemy is too tough, it'll explode as a final attempt to beat them.");
const u8 gLizakbarPokedexText[] = _(
	"It explodes with enough power to destroy buildings.\n"
    "If a wild one is seen near a city, it's removed for security\n"
    "reasons.");
const u8 gCarolinePokedexText[] = _(
	"Caroline is a talking quail.");
const u8 gGlasshotPokedexText[] = _(
	"Despite being being able to dish out very powerful shots,\n"
    "a mere punch is enough to take this Pokémon down.");
const u8 gGlassannonPokedexText[] = _(
	"Even though Glassannon is known as a fast, cold blooded exterminator,\n"
    "its glassy body is extremely fragile.");
const u8 gMotherfuckPokedexText[] = _(
	"Motherfuck finds great joy in torturing other Pokémon,\n"
    "even if it faints itself in the process.");

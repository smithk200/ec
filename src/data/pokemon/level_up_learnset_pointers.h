const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_FISHNISM] = sFishnismLevelUpLearnset,
    [SPECIES_SJWHALE] = sSjwhaleLevelUpLearnset,
    ...
    [SPECIES_CHEZETTA] = sLifinhelLevelUpLearnset,
    [SPECIES_MOZZAMAZEL] = sBarticulaLevelUpLearnset,
    [SPECIES_SINGLETS] = sSingletsLevelUpLearnset,
    [SPECIES_DUBUS] = sDubusLevelUpLearnset,
    [SPECIES_TRIPSIUS] = sTripsiusLevelUpLearnset,
    [SPECIES_SAPLEAF] = sSapleafLevelUpLearnset,
    [SPECIES_IGNUT] = sIgnutLevelUpLearnset,
    [SPECIES_PHANTASH] = sPhantashLevelUpLearnset,
    [SPECIES_SMOGAROBEN] = sSmogarobenLevelUpLearnset,
    [SPECIES_SMOXILON] = sSmoxilonLevelUpLearnset,
    [SPECIES_SPRUCIFIX] = sSprucifixLevelUpLearnset,
    [SPECIES_CHARAGON] = sCharagonLevelUpLearnset,
    [SPECIES_HYLETRACK] = sHyletrackLevelUpLearnset,
    [SPECIES_POLLEFIN] = sPollefinLevelUpLearnset,
    [SPECIES_FLORIGRACE] = sFlorigraceLevelUpLearnset,
    [SPECIES_ARABOMB] = sArabombLevelUpLearnset,
    [SPECIES_IGUALLAH] = sIguallahLevelUpLearnset,
    [SPECIES_LIZAKBAR] = sLizakbarLevelUpLearnset,
    [SPECIES_CAROLINE] = sCarolineLevelUpLearnset,
    [SPECIES_GLASSHOT] = sGlasshotLevelUpLearnset,
    [SPECIES_GLASSANNON] = sGlassannonLevelUpLearnset,
    [SPECIES_MOTHERFUCK] = sMotherfuckLevelUpLearnset,
    [SPECIES_LARVADES] = sLarvadesLevelUpLearnset,
    [SPECIES_PROBOSKITO] = sProboskitoLevelUpLearnset,
    [SPECIES_VENOWATT] = sVenowattLevelUpLearnset,
    [SPECIES_ADESIGN] = sAdesignLevelUpLearnset,
    [SPECIES_BACUB] = sBacubLevelUpLearnset,
    [SPECIES_URSWINE] = sUrswineLevelUpLearnset,
    [SPECIES_TRICIENT] = sTricientLevelUpLearnset,
    [SPECIES_TRICILLION] = sTricillionLevelUpLearnset,
    [SPECIES_CLOVENIX] = sClovenixLevelUpLearnset,
    [SPECIES_INBITWEEN] = sInbitweenLevelUpLearnset,
    [SPECIES_GEIGH] = sGeighLevelUpLearnset,
    [SPECIES_DRAGKING] = sDragkingLevelUpLearnset,
    [SPECIES_BLISSEY_EV_TRAIN] = sBlisseyEVTrainLevelUpLearnset,

...
{
    [SPECIES_FISHNISM]              = {{EVO_LEVEL, 35, SPECIES_SJWHALE}},
    [SPECIES_BONGECKO]              = {{EVO_LEVEL, 24, SPECIES_MARIGUANA}},
    [SPECIES_MARIGUANA]              = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_MARLEYZARD}},
    [SPECIES_CHEZETTA]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_MOZZAMAZEL}},
    [SPECIES_SINGLETS]              = {{EVO_LEVEL, 22, SPECIES_DUBUS}},
    [SPECIES_DUBUS]              = {{EVO_LEVEL, 33, SPECIES_TRIPSIUS}},
    [SPECIES_SAPLEAF]              = {{EVO_LEVEL, 15, SPECIES_IGNUT}},
    [SPECIES_IGNUT]              = {{EVO_LEVEL, 34, SPECIES_PHANTASH}},
    [SPECIES_SMOGAROBEN]              = {{EVO_LEVEL, 16, SPECIES_SMOXILON}},
    [SPECIES_CHARAGON]              = {{EVO_LEVEL, 30, SPECIES_HYLETRACK}},
    [SPECIES_POLLEFIN]              = {{EVO_LEVEL, 26, SPECIES_FLORIGRACE}},
    [SPECIES_ARABOMB]              = {{EVO_LEVEL, 16, SPECIES_IGUALLAH}},
    [SPECIES_IGUALLAH]              = {{EVO_LEVEL, 36, SPECIES_LIZAKBAR}},
    [SPECIES_GLASSHOT]              = {{EVO_LEVEL, 30, SPECIES_GLASSANNON}},
    [SPECIES_LARVADES]              = {{EVO_LEVEL, 15, SPECIES_PROBOSKITO}},
    [SPECIES_PROBOSKITO]            = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_VENOWATT}},
    [SPECIES_BACUB]              = {{EVO_LEVEL, 32, SPECIES_URSWINE}},
    [SPECIES_TRICIENT]              = {{EVO_LEVEL, 37, SPECIES_TRICILLION}},
    [SPECIES_INBITWEEN]              = {{EVO_LEVEL, 40, SPECIES_GEIGH},
                                       {EVO_ITEM, ITEM_SUN_STONE, SPECIES_DRAGKING}},
    ...
    [SPECIES_SLOWBRO]               = {{EVO_LEVEL, 60, SPECIES_SLOWKING},
    ...
    [SPECIES_PICHU]                 = {{EVO_LEVEL, 36, SPECIES_PIKACHU}},
    [SPECIES_CLEFFA]                = {{EVO_LEVEL, 36, SPECIES_CLEFAIRY}},
    [SPECIES_IGGLYBUFF]             = {{EVO_LEVEL, 36, SPECIES_JIGGLYPUFF}},
    [SPECIES_TOGEPI]                = {{EVO_LEVEL, 36, SPECIES_TOGETIC}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_WURMPLE]               = {{EVO_LEVEL_ATK_LT_DEF, 7, SPECIES_CASCOON},
                                       {EVO_LEVEL_ATK_GT_DEF, 7, SPECIES_SILCOON}},
...
#if P_GEN_4_POKEMON == TRUE
    [SPECIES_NOSEPASS]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_PROBOPASS}},
#endif
    ...
    [SPECIES_FEEBAS]                = {{EVO_BEAUTY, 170, SPECIES_MILOTIC},
                                       {EVO_ITEM, ITEM_MOON_STONE, SPECIES_MILOTIC}},
    ...
    [SPECIES_BUDEW]                 = {{EVO_LEVEL, 36, SPECIES_ROSELIA}},

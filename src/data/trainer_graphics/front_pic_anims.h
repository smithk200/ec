static const union AnimCmd *const sAnims_Ned[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_Bender[] ={
    sAnim_GeneralFrame0,
};
static const union AnimCmd *const sAnims_Snoop[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Fry[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Tumblrita[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_Captain_Floyd[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LEADER_NED] = sAnims_Ned,
    [TRAINER_PIC_LEADER_BENDER] = sAnims_Bender,
    [TRAINER_PIC_ELITE_FOUR_SNOOP] = sAnims_Snoop,
    [TRAINER_PIC_ELITE_FOUR_JOY] = sAnims_Joy,
    [TRAINER_PIC_ELITE_FOUR_TUMBLRITA] = sAnims_Tumblrita,
    [TRAINER_PIC_ELITE_FOUR_CAPTAIN_FLOYD] = sAnims_Captain_Floyd,
    [TRAINER_PIC_CYNTHIA] = sAnims_Cynthia,
    [TRAINER_PIC_LEADER_NEW_FLANNERY] = sAnims_Cynthia,
    ...
    [TRAINER_PIC_LEADER_BILL_NYE] = sAnims_LeaderWattson,

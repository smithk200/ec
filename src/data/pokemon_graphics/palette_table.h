const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(FISHNISM, gMonPalette_Fishnism),
    SPECIES_PAL(SJWHALE, gMonPalette_Sjwhale),
    ...
    SPECIES_PAL(CHEZETTA, gMonPalette_Chezetta),
    SPECIES_PAL(MOZZAMAZEL, gMonPalette_Mozzamazel),
    SPECIES_PAL(SINGLETS, gMonPalette_Singlets),
    SPECIES_PAL(DUBUS, gMonPalette_Dubus),
    SPECIES_PAL(TRIPSIUS, gMonPalette_Tripsius),
    SPECIES_PAL(SAPLEAF, gMonPalette_Sapleaf),
    SPECIES_PAL(IGNUT, gMonPalette_Ignut),
    SPECIES_PAL(PHANTASH, gMonPalette_Phantash),
    SPECIES_PAL(SMOGAROBEN, gMonPalette_Smogaroben),
    SPECIES_PAL(SMOXILON, gMonPalette_Smoxilon),
    SPECIES_PAL(SPRUCIFIX, gMonPalette_Sprucifix),
    SPECIES_PAL(CHARAGON, gMonPalette_Charagon),
    SPECIES_PAL(HYLETRACK, gMonPalette_Hyletrack),
    SPECIES_PAL(POLLEFIN, gMonPalette_Pollefin),
    SPECIES_PAL(FLORIGRACE, gMonPalette_Florigrace),
    SPECIES_PAL(ARABOMB, gMonPalette_Arabomb),
    SPECIES_PAL(IGUALLAH, gMonPalette_Iguallah),
    SPECIES_PAL(LIZAKBAR, gMonPalette_Lizakbar),
    SPECIES_PAL(CAROLINE, gMonPalette_Caroline),
    SPECIES_PAL(GLASSHOT, gMonPalette_Glasshot),
    SPECIES_PAL(GLASSANNON, gMonPalette_Glassannon),
    SPECIES_PAL(MOTHERFUCK, gMonPalette_Motherfuck),
    SPECIES_PAL(BLISSEY_EV_TRAIN, gMonPalette_Blissey),
    SPECIES_PAL(LARVADES, gMonPalette_Larvades),
    SPECIES_PAL(PROBOSKITO, gMonPalette_Proboskito),
    SPECIES_PAL(VENOWATT, gMonPalette_Venowatt),
    SPECIES_PAL(ADESIGN, gMonPalette_Adesign),
    SPECIES_PAL(BACUB, gMonPalette_Bacub),
    SPECIES_PAL(URSWINE, gMonPalette_Urswine),
    SPECIES_PAL(TRICIENT, gMonPalette_Tricient),
    SPECIES_PAL(TRICILLION, gMonPalette_Tricillion),
    SPECIES_PAL(CLOVENIX, gMonPalette_Clovenix),
    SPECIES_PAL(INBITWEEN, gMonPalette_Inbitween),
    SPECIES_PAL(GEIGH, gMonPalette_Geigh),
    SPECIES_PAL(DRAGKING, gMonPalette_Dragking),

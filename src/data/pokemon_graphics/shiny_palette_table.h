const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(FISHNISM, gMonShinyPalette_Fishnism),
    SPECIES_SHINY_PAL(SJWHALE, gMonShinyPalette_Sjwhale),
    SPECIES_SHINY_PAL(BONGECKO, gMonShinyPalette_Bongecko),
    SPECIES_SHINY_PAL(MARIGUANA, gMonShinyPalette_Mariguana),
    SPECIES_SHINY_PAL(MARLEYZARD, gMonShinyPalette_Marleyzard),
    SPECIES_SHINY_PAL(CHEZETTA, gMonShinyPalette_Chezetta),
    SPECIES_SHINY_PAL(MOZZAMAZEL, gMonShinyPalette_Mozzamazel),
    SPECIES_SHINY_PAL(SINGLETS, gMonShinyPalette_Singlets),
    SPECIES_SHINY_PAL(DUBUS, gMonShinyPalette_Dubus),
    SPECIES_SHINY_PAL(TRIPSIUS, gMonShinyPalette_Tripsius),
    SPECIES_SHINY_PAL(SAPLEAF, gMonShinyPalette_Sapleaf),
    SPECIES_SHINY_PAL(IGNUT, gMonShinyPalette_Ignut),
    SPECIES_SHINY_PAL(PHANTASH, gMonShinyPalette_Phantash),
    SPECIES_SHINY_PAL(SMOGAROBEN, gMonShinyPalette_Smogaroben),
    SPECIES_SHINY_PAL(SMOXILON, gMonShinyPalette_Smoxilon),
    SPECIES_SHINY_PAL(SPRUCIFIX, gMonShinyPalette_Sprucifix),
    SPECIES_SHINY_PAL(CHARAGON, gMonShinyPalette_Charagon),
    SPECIES_SHINY_PAL(HYLETRACK, gMonShinyPalette_Hyletrack),
    SPECIES_SHINY_PAL(POLLEFIN, gMonShinyPalette_Pollefin),
    SPECIES_SHINY_PAL(FLORIGRACE, gMonShinyPalette_Florigrace),
    SPECIES_SHINY_PAL(ARABOMB, gMonShinyPalette_Arabomb),
    SPECIES_SHINY_PAL(IGUALLAH, gMonShinyPalette_Iguallah),
    SPECIES_SHINY_PAL(LIZAKBAR, gMonShinyPalette_Lizakbar),
    SPECIES_SHINY_PAL(CAROLINE, gMonShinyPalette_Caroline),
    SPECIES_SHINY_PAL(GLASSHOT, gMonShinyPalette_Glasshot),
    SPECIES_SHINY_PAL(GLASSANNON, gMonShinyPalette_Glassannon),
    SPECIES_SHINY_PAL(MOTHERFUCK, gMonShinyPalette_Motherfuck),
    SPECIES_SHINY_PAL(BLISSEY_EV_TRAIN, gMonShinyPalette_Blissey),
    SPECIES_SHINY_PAL(LARVADES, gMonShinyPalette_Larvades),
    SPECIES_SHINY_PAL(PROBOSKITO, gMonShinyPalette_Proboskito),
    SPECIES_SHINY_PAL(VENOWATT, gMonShinyPalette_Venowatt),
    SPECIES_SHINY_PAL(ADESIGN, gMonShinyPalette_Adesign),
    SPECIES_SHINY_PAL(BACUB, gMonShinyPalette_Bacub),
    SPECIES_SHINY_PAL(URSWINE, gMonShinyPalette_Urswine),
    SPECIES_SHINY_PAL(TRICIENT, gMonShinyPalette_Tricient),
    SPECIES_SHINY_PAL(TRICILLION, gMonShinyPalette_Tricillion),
    SPECIES_SHINY_PAL(CLOVENIX, gMonShinyPalette_Clovenix),
    SPECIES_SHINY_PAL(INBITWEEN, gMonShinyPalette_Inbitween),
    SPECIES_SHINY_PAL(GEIGH, gMonShinyPalette_Geigh),
    SPECIES_SHINY_PAL(DRAGKING, gMonShinyPalette_Dragking),

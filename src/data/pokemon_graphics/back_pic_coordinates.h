...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_BLISSEY_EV_TRAIN]     = { .size = MON_COORDS_SIZE(64, 40), .y_offset = 13 },
    ...
    [SPECIES_FISHNISM]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_SJWHALE]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_BONGECKO]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_MARIGUANA]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_MARLEYZARD]				= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_CHEZETTA]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_MOZZAMAZEL]				= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_SINGLETS]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_DUBUS]					    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_TRIPSIUS]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_SAPLEAF]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 20 },
    [SPECIES_IGNUT]					    = { .size = MON_COORDS_SIZE(64, 64), .y_offset = 20 },
    [SPECIES_PHANTASH]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 20 },
    [SPECIES_SMOGAROBEN]				= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 20 },
    [SPECIES_SMOXILON]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 10 },
    [SPECIES_SPRUCIFIX]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_CHARAGON]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 0 },
    [SPECIES_HYLETRACK]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 3 },
    [SPECIES_POLLEFIN]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_FLORIGRACE]				= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_ARABOMB]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_IGUALLAH]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_LIZAKBAR]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_CAROLINE]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 5 },
    [SPECIES_GLASSHOT]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_GLASSANNON]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_MOTHERFUCK]					= { .size = MON_COORDS_SIZE(64, 64), .y_offset = 16 },
    [SPECIES_LARVADES]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  9 },
    [SPECIES_PROBOSKITO]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_VENOWATT]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_ADESIGN]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  20 },
    [SPECIES_BACUB]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_URSWINE]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  5 },
    [SPECIES_TRICIENT]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_TRICILLION]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_CLOVENIX]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_INBITWEEN]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },
    [SPECIES_GEIGH]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_DRAGKING]        = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  10 },

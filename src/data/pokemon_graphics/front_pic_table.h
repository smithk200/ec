const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(FISHNISM, gMonFrontPic_Fishnism),
    SPECIES_SPRITE(SJWHALE, gMonFrontPic_Sjwhale),
    ...
    SPECIES_SPRITE(CHEZETTA, gMonFrontPic_Chezetta),
    SPECIES_SPRITE(MOZZAMAZEL, gMonFrontPic_Mozzamazel),
    SPECIES_SPRITE(SINGLETS, gMonFrontPic_Singlets),
    SPECIES_SPRITE(DUBUS, gMonFrontPic_Dubus),
    SPECIES_SPRITE(TRIPSIUS, gMonFrontPic_Tripsius),
    SPECIES_SPRITE(SAPLEAF, gMonFrontPic_Sapleaf),
    SPECIES_SPRITE(IGNUT, gMonFrontPic_Ignut),
    SPECIES_SPRITE(PHANTASH, gMonFrontPic_Phantash),
    SPECIES_SPRITE(SMOGAROBEN, gMonFrontPic_Smogaroben),
    SPECIES_SPRITE(SMOXILON, gMonFrontPic_Smoxilon),
    SPECIES_SPRITE(SPRUCIFIX, gMonFrontPic_Sprucifix),
    SPECIES_SPRITE(CHARAGON, gMonFrontPic_Charagon),
    SPECIES_SPRITE(HYLETRACK, gMonFrontPic_Hyletrack),
    SPECIES_SPRITE(POLLEFIN, gMonFrontPic_Pollefin),
    SPECIES_SPRITE(FLORIGRACE, gMonFrontPic_Florigrace),
    SPECIES_SPRITE(ARABOMB, gMonFrontPic_Arabomb),
    SPECIES_SPRITE(IGUALLAH, gMonFrontPic_Iguallah),
    SPECIES_SPRITE(LIZAKBAR, gMonFrontPic_Lizakbar),
    SPECIES_SPRITE(CAROLINE, gMonFrontPic_Caroline),
    SPECIES_SPRITE(GLASSHOT, gMonFrontPic_Glasshot),
    SPECIES_SPRITE(GLASSANNON, gMonFrontPic_Glassannon),
    SPECIES_SPRITE(MOTHERFUCK, gMonFrontPic_Motherfuck),
    SPECIES_SPRITE(LARVADES, gMonFrontPic_Larvades),
    SPECIES_SPRITE(PROBOSKITO, gMonFrontPic_Proboskito),
    SPECIES_SPRITE(VENOWATT, gMonFrontPic_Venowatt),
    SPECIES_SPRITE(ADESIGN, gMonFrontPic_Adesign),
    SPECIES_SPRITE(BACUB, gMonFrontPic_Bacub),
    SPECIES_SPRITE(URSWINE, gMonFrontPic_Urswine),
    SPECIES_SPRITE(TRICIENT, gMonFrontPic_Tricient),
    SPECIES_SPRITE(TRICILLION, gMonFrontPic_Tricillion),
    SPECIES_SPRITE(CLOVENIX, gMonFrontPic_Clovenix),
    SPECIES_SPRITE(INBITWEEN, gMonFrontPic_Inbitween),
    SPECIES_SPRITE(GEIGH, gMonFrontPic_Geigh),
    SPECIES_SPRITE(DRAGKING, gMonFrontPic_Dragking),
    SPECIES_SPRITE(BLISSEY_EV_TRAIN, gMonFrontPic_Blissey),

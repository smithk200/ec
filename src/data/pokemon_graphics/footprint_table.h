const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_BLISSEY_EV_TRAIN] = gMonFootprint_Blissey,
    ...
    [SPECIES_FISHNISM] = gMonFootprint_Fishnism,
    [SPECIES_SJWHALE] = gMonFootprint_Sjwhale,
    ...
    [SPECIES_CHEZETTA] = gMonFootprint_Chezetta,
    [SPECIES_MOZZAMAZEL] = gMonFootprint_Mozzamazel,
    [SPECIES_SINGLETS] = gMonFootprint_Singlets,
    [SPECIES_DUBUS] = gMonFootprint_Dubus,
    [SPECIES_TRIPSIUS] = gMonFootprint_Tripsius,
    [SPECIES_SAPLEAF] = gMonFootprint_Sapleaf,
    [SPECIES_IGNUT] = gMonFootprint_Ignut,
    [SPECIES_PHANTASH] = gMonFootprint_Phantash,
    [SPECIES_SMOGAROBEN] = gMonFootprint_Smogaroben,
    [SPECIES_SMOXILON] = gMonFootprint_Smoxilon,
    [SPECIES_SPRUCIFIX] = gMonFootprint_Sprucifix,
    [SPECIES_CHARAGON] = gMonFootprint_Charagon,
    [SPECIES_HYLETRACK] = gMonFootprint_Hyletrack,
    [SPECIES_POLLEFIN] = gMonFootprint_Pollefin,
    [SPECIES_FLORIGRACE] = gMonFootprint_Florigrace,
    [SPECIES_ARABOMB] = gMonFootprint_Arabomb,
    [SPECIES_IGUALLAH] = gMonFootprint_Iguallah,
    [SPECIES_LIZAKBAR] = gMonFootprint_Lizakbar,
    [SPECIES_CAROLINE] = gMonFootprint_Caroline,
    [SPECIES_GLASSHOT] = gMonFootprint_Glasshot,
    [SPECIES_GLASSANNON] = gMonFootprint_Glassannon,
    [SPECIES_MOTHERFUCK] = gMonFootprint_Motherfuck,
    [SPECIES_LARVADES] = gMonFootprint_Larvades,
    [SPECIES_PROBOSKITO] = gMonFootprint_Proboskito,
    [SPECIES_VENOWATT] = gMonFootprint_Venowatt,
    [SPECIES_ADESIGN] = gMonFootprint_Adesign,
    [SPECIES_BACUB] = gMonFootprint_Bacub,
    [SPECIES_URSWINE] = gMonFootprint_Urswine,
    [SPECIES_TRICIENT] = gMonFootprint_Tricient,
    [SPECIES_TRICILLION] = gMonFootprint_Tricillion,
    [SPECIES_CLOVENIX] = gMonFootprint_Clovenix,
    [SPECIES_INBITWEEN] = gMonFootprint_Inbitween,
    [SPECIES_GEIGH] = gMonFootprint_Geigh,
    [SPECIES_DRAGKING] = gMonFootprint_Dragking,
#endif

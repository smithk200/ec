const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(FISHNISM, gMonBackPic_Fishnism),
    SPECIES_SPRITE(SJWHALE, gMonBackPic_Sjwhale),
    ...
    SPECIES_SPRITE(CHEZETTA, gMonBackPic_Chezetta),
    SPECIES_SPRITE(MOZZAMAZEL, gMonBackPic_Mozzamazel),
    SPECIES_SPRITE(SINGLETS, gMonBackPic_Singlets),
    SPECIES_SPRITE(DUBUS, gMonBackPic_Dubus),
    SPECIES_SPRITE(TRIPSIUS, gMonBackPic_Tripsius),
    SPECIES_SPRITE(SAPLEAF, gMonBackPic_Sapleaf),
    SPECIES_SPRITE(IGNUT, gMonBackPic_Ignut),
    SPECIES_SPRITE(PHANTASH, gMonBackPic_Phantash),
    SPECIES_SPRITE(SMOGAROBEN, gMonBackPic_Smogaroben),
    SPECIES_SPRITE(SMOXILON, gMonBackPic_Smoxilon),
    SPECIES_SPRITE(SPRUCIFIX, gMonBackPic_Sprucifix),
    SPECIES_SPRITE(CHARAGON, gMonBackPic_Charagon),
    SPECIES_SPRITE(HYLETRACK, gMonBackPic_Hyletrack),
    SPECIES_SPRITE(POLLEFIN, gMonBackPic_Pollefin),
    SPECIES_SPRITE(FLORIGRACE, gMonBackPic_Florigrace),
    SPECIES_SPRITE(ARABOMB, gMonBackPic_Arabomb),
    SPECIES_SPRITE(IGUALLAH, gMonBackPic_Iguallah),
    SPECIES_SPRITE(LIZAKBAR, gMonBackPic_Lizakbar),
    SPECIES_SPRITE(CAROLINE, gMonBackPic_Caroline),
    SPECIES_SPRITE(GLASSHOT, gMonBackPic_Glasshot),
    SPECIES_SPRITE(GLASSANNON, gMonBackPic_Glassannon),
    SPECIES_SPRITE(MOTHERFUCK, gMonBackPic_Motherfuck),
    SPECIES_SPRITE(BLISSEY_EV_TRAIN, gMonBackPic_Blissey),
    SPECIES_SPRITE(LARVADES, gMonBackPic_Larvades),
    SPECIES_SPRITE(PROBOSKITO, gMonBackPic_Proboskito),
    SPECIES_SPRITE(VENOWATT, gMonBackPic_Venowatt),
    SPECIES_SPRITE(ADESIGN, gMonBackPic_Adesign),
    SPECIES_SPRITE(BACUB, gMonBackPic_Bacub),
    SPECIES_SPRITE(URSWINE, gMonBackPic_Urswine),
    SPECIES_SPRITE(TRICIENT, gMonBackPic_Tricient),
    SPECIES_SPRITE(TRICILLION, gMonBackPic_Tricillion),
    SPECIES_SPRITE(CLOVENIX, gMonBackPic_Clovenix),
    SPECIES_SPRITE(INBITWEEN, gMonBackPic_Inbitween),
    SPECIES_SPRITE(GEIGH, gMonBackPic_Geigh),
    SPECIES_SPRITE(DRAGKING, gMonBackPic_Dragking),

...
const u16 gEasyChatWordsByLetter_A[] = {
    ...
    EC_WORD_AM,
    EC_MOVE2(AMNESIA),
    EC_POKEMON_NATIONAL(FISHNISM),
    EC_POKEMON_NATIONAL(SJWHALE),
    EC_POKEMON_NATIONAL(BONGECKO),
    EC_POKEMON_NATIONAL(MARIGUANA),
    EC_POKEMON_NATIONAL(MARLEYZARD),
    EC_POKEMON_NATIONAL(CHEZETTA),
    EC_POKEMON_NATIONAL(MOZZAMAZEL),
    EC_POKEMON_NATIONAL(SINGLETS),
    EC_POKEMON_NATIONAL(DUBUS),
    EC_POKEMON_NATIONAL(TRIPSIUS),
    EC_POKEMON_NATIONAL(SAPLEAF),
    EC_POKEMON_NATIONAL(IGNUT),
    EC_POKEMON_NATIONAL(PHANTASH),
    EC_POKEMON_NATIONAL(SMOGAROBEN),
    EC_POKEMON_NATIONAL(SMOXILON),
    EC_POKEMON_NATIONAL(SPRUCIFIX),
    EC_POKEMON_NATIONAL(AMPHAROS),
    EC_POKEMON_NATIONAL(CHARAGON),
    EC_POKEMON_NATIONAL(HYLETRACK),
    EC_POKEMON_NATIONAL(POLLEFIN),
    EC_POKEMON_NATIONAL(FLORIGRACE),
    EC_POKEMON_NATIONAL(ARABOMB),
    EC_POKEMON_NATIONAL(IGUALLAH),
    EC_POKEMON_NATIONAL(LIZAKBAR),
    EC_POKEMON_NATIONAL(CAROLINE),
    EC_POKEMON_NATIONAL(GLASSHOT),
    EC_POKEMON_NATIONAL(GLASSANNON),
    EC_POKEMON_NATIONAL(MOTHERFUCK),
    EC_POKEMON_NATIONAL(LARVADES),
    EC_POKEMON_NATIONAL(PROBOSKITO),
    EC_POKEMON_NATIONAL(VENOWATT),
    EC_POKEMON_NATIONAL(ADESIGN),
    EC_POKEMON_NATIONAL(BACUB),
    EC_POKEMON_NATIONAL(URSWINE),
    EC_POKEMON_NATIONAL(TRICIENT),
    EC_POKEMON_NATIONAL(TRICILLION),
    EC_POKEMON_NATIONAL(CLOVENIX),
    EC_POKEMON_NATIONAL(INBITWEEN),
    EC_POKEMON_NATIONAL(GEIGH),
    EC_POKEMON_NATIONAL(DRAGKING),
    EC_WORD_AMUSING,
    EC_WORD_AN,

...
static const u8 sTriggerDescription[] = _(
    "This psychic attack gets stronger\n"
    "if used in succession.");

static const u8 sSpeedWeedDescription[] = _(
    "A speedy Grass-type\n"
    "attack. A priority move.");
    
static const u8 sHolyDutyDescription[] = _(
    "A suicidal attack that\n"
    "blows up everyone.");

static const u8 sRazorWingDescription[] = _(
    "The foe is hit with\n"
    "razor-sharp wings.");

static const u8 sChaosDunkDescription[] = _(
    "The user grabs the target\n"
    "and slam-dunks it.");

static const u8 sHolyDutyCPUDescription[] = _(
    "You should not have\n"
    "this move.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] =
{
    ...
    [MOVE_TRIGGER - 1] = sTriggerDescription,
    [MOVE_SPEED_WEED - 1] = sSpeedWeedDescription,
    [MOVE_HOLY_DUTY - 1] = sHolyDutyDescription,
    [MOVE_RAZOR_WING - 1] = sRazorWingDescription,

const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_CORVIKNIGHT] = _("Corvinight"),
    ...
    [SPECIES_FISHNISM] = _("Fishnism"),
    [SPECIES_SJWHALE] = _("Sjwhale"),
    [SPECIES_BONGECKO] = _("Bongecko"),
    [SPECIES_MARIGUANA] = _("Mariguana"),
    [SPECIES_MARLEYZARD] = _("Marleyzard"),
    [SPECIES_CHEZETTA] = _("Lifinhel"),
    [SPECIES_MOZZAMAZEL] = _("Barticula"),
    [SPECIES_SINGLETS] = _("Singlets"),
    [SPECIES_DUBUS] = _("Dubus"),
    [SPECIES_TRIPSIUS] = _("Tripsius"),
    [SPECIES_SAPLEAF] = _("Sapleaf"),
    [SPECIES_IGNUT] = _("Ignut"),
    [SPECIES_PHANTASH] = _("Phantash"),
    [SPECIES_SMOGAROBEN] = _("Smogaroben"),
    [SPECIES_SMOXILON] = _("Smoxilon"),
    [SPECIES_SPRUCIFIX] = _("Sprucifix"),
    [SPECIES_CHARAGON] = _("Charagon"),
    [SPECIES_HYLETRACK] = _("Hyletrack"),
    [SPECIES_POLLEFIN] = _("Pollefin"),
    [SPECIES_FLORIGRACE] = _("Florigrace"),
    [SPECIES_ARABOMB] = _("Arabomb"),
    [SPECIES_IGUALLAH] = _("Iguallah"),
    [SPECIES_LIZAKBAR] = _("Lizakbar"),
    [SPECIES_CAROLINE] = _("Caroline"),
    [SPECIES_GLASSHOT] = _("Glasshot"),
    [SPECIES_GLASSANNON] = _("Glassannon"),
    [SPECIES_MOTHERFUCK] = _("Motherfuck"),
    [SPECIES_BLISSEY_EV_TRAIN] = _("Blissey"),
    [SPECIES_LARVADES] = _("Larvades"),
    [SPECIES_PROBOSKITO] = _("Proboskito"),
    [SPECIES_VENOWATT] = _("Venowatt"),
    [SPECIES_ADESIGN] = _("Adesign"),
    [SPECIES_BACUB] = _("Bacub"),
    [SPECIES_URSWINE] = _("Urswine"),
    [SPECIES_TRICIENT] = _("Tricient"),
    [SPECIES_TRICILLION] = _("Tricillion"),
    [SPECIES_CLOVENIX] = _("Clovenix"),
    [SPECIES_INBITWEEN] = _("Inbitween"),
    [SPECIES_GEIGH] = _("Geigh"),
    [SPECIES_DRAGKING] = _("Dragking"),

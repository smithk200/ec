...
const u8 gText_MatchCallPassionBurn_Flannery_Strategy[] = _("I battle.");
const u8 gText_MatchCallPassionBurn_Flannery_Pokemon[] = _("Are magical magical.");
const u8 gText_MatchCallPassionBurn_Flannery_Intro1[] = _("...");
const u8 gText_MatchCallPassionBurn_Flannery_Intro2[] = _("...");
...
const u8 gText_MatchCallSkyTamer_Winona_Strategy[] = _("Praise the Holy God!");
const u8 gText_MatchCallSkyTamer_Winona_Pokemon[] = _("Holy Pokémon.");
const u8 gText_MatchCallSkyTamer_Winona_Intro1[] = _("The ultimate would be to");
const u8 gText_MatchCallSkyTamer_Winona_Intro2[] = _("live with Jesus Christ.");
...
const u8 gText_MatchCallDandyCharm_Juan_Strategy[] = _("Alcohol.");
const u8 gText_MatchCallDandyCharm_Juan_Pokemon[] = _("Pokémon that drink beer.");
const u8 gText_MatchCallDandyCharm_Juan_Intro1[] = _("The adulation of beautiful");
const u8 gText_MatchCallDandyCharm_Juan_Intro2[] = _("fembots fills me with energy!");

const u8 gText_MatchCallEliteFour_Sidney_Strategy[] = _("Feminist");
const u8 gText_MatchCallEliteFour_Sidney_Pokemon[] = _("Hey! Stop snooping!");
const u8 gText_MatchCallEliteFour_Sidney_Intro1[] = _("Die, you patriarchal");
const u8 gText_MatchCallEliteFour_Sidney_Intro2[] = _("asshole!");

const u8 gText_MatchCallEliteFour_Phoebe_Strategy[] = _("");
const u8 gText_MatchCallEliteFour_Phoebe_Pokemon[] = _("Ice");
const u8 gText_MatchCallEliteFour_Phoebe_Intro1[] = _("");
const u8 gText_MatchCallEliteFour_Phoebe_Intro2[] = _("");

const u8 gText_MatchCallEliteFour_Glacia_Strategy[] = _("Cute Pokémon");
const u8 gText_MatchCallEliteFour_Glacia_Pokemon[] = _("Electric");
const u8 gText_MatchCallEliteFour_Glacia_Intro1[] = _("I love Pokémon!");
const u8 gText_MatchCallEliteFour_Glacia_Intro2[] = _("Jolteon, use Thunderbolt!");

const u8 gText_MatchCallEliteFour_Drake_Strategy[] = _("Weed.");
const u8 gText_MatchCallEliteFour_Drake_Pokemon[] = _("High as FUCK!");
const u8 gText_MatchCallEliteFour_Drake_Intro1[] = _("My Pokémon trained");
const u8 gText_MatchCallEliteFour_Drake_Intro2[] = _("on pure weed.");

const u8 gText_MatchCallChampion_Wallace_Strategy[] = _("Dignity and respect.");
const u8 gText_MatchCallChampion_Wallace_Pokemon[] = _("I prefer Pokémon of power.");

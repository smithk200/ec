...
static const struct TrainerMonItemCustomMoves sParty_ShellySeafloorCavern[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_SCARY_FACE, MOVE_TAKE_DOWN, MOVE_NIGHT_SLASH, MOVE_PSYCHIC_FANGS}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_AIR_CUTTER, MOVE_SCREECH, MOVE_POISON_JAB, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_TRIGGER, MOVE_ICE_SHARD, MOVE_LIQUIDATION, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_PHANTOM_FORCE, MOVE_ENERGY_BALL, MOVE_ICE_BEAM, MOVE_NASTY_PLOT}
    },
    {
    .iv = 255,
    .lvl = 51,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_SURF, MOVE_SCREECH, MOVE_CRUNCH, MOVE_AGILITY}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Archie[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_CRUNCH, MOVE_CONFUSE_RAY, MOVE_RAZOR_WING, MOVE_POISON_JAB}
    },
    {
    .iv = 255,
    .lvl = 50,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_AIR_CUTTER, MOVE_DARK_PULSE, MOVE_ICE_BEAM, MOVE_NASTY_PLOT}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_THROAT_CHOP, MOVE_SLASH, MOVE_BRICK_BREAK, MOVE_AGILITY}
    },
    {
    .iv = 255,
    .lvl = 52,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_SPEED_WEED, MOVE_NASTY_PLOT}
    },
    {
    .iv = 255,
    .lvl = 53,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FOUL_PLAY, MOVE_LIQUIDATION, MOVE_SCREECH, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .abilityNums = 0,
    .moves = {MOVE_HEAT_CRASH, MOVE_AGILITY, MOVE_SPEED_WEED, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .heldItem = ITEM_QUICK_CLAW,
    .abilityNums = 0,
    .moves = {MOVE_BUG_BUZZ, MOVE_AGILITY, MOVE_AQUA_JET, MOVE_ICE_SHARD}
    },
    {
    .iv = 255,
    .lvl = 38,
    .species = SPECIES_GLASSANNON,
    .heldItem = ITEM_QUICK_CLAW,
    .abilityNums = 0,
    .moves = {MOVE_ICE_BEAM, MOVE_AGILITY, MOVE_FLASH_CANNON, MOVE_SPEED_WEED}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_TEETER_DANCE, MOVE_SLAM, MOVE_PSYBEAM, MOVE_DIZZY_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_REVELATION_DANCE, MOVE_TEETER_DANCE, MOVE_SWORDS_DANCE, MOVE_LUNAR_DANCE}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .abilityNums = 0,
    .moves = {MOVE_CONFUSE_RAY, MOVE_GLARE, MOVE_HEX, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = {
    ...
    .moves = {MOVE_SLACK_OFF, MOVE_COUNTER, MOVE_SHADOW_BALL, MOVE_MACH_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 39,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_WATMEL_BERRY,
    .moves = {MOVE_ROOST, MOVE_RAIN_DANCE, MOVE_SCALD, MOVE_WING_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 39,
    .species = SPECIES_SJWHALE,
    .heldItem = ITEM_WATMEL_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_LIQUIDATION, MOVE_TRIGGER, MOVE_AMNESIA}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_SWORDS_DANCE, MOVE_THROAT_CHOP, MOVE_SLASH, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_HOLY_DUTY_CPU, MOVE_NONE, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_SWORDS_DANCE, MOVE_LOCK_ON, MOVE_GUILLOTINE, MOVE_SLASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SMOKESCREEN, MOVE_HONE_CLAWS, MOVE_BATON_PASS, MOVE_SLASH}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FEINT_ATTACK, MOVE_SHOCK_WAVE, MOVE_FLARE_BLITZ, MOVE_BATON_PASS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .moves = {MOVE_WILL_O_WISP, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_SOFT_BOILED}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .moves = {MOVE_TRIGGER, MOVE_LIQUIDATION, MOVE_SLACK_OFF, MOVE_DEFENSE_CURL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_IRON_HEAD, MOVE_NIGHT_SLASH}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .moves = {MOVE_IRON_DEFENSE, MOVE_PLAY_ROUGH, MOVE_IRON_HEAD, MOVE_MACH_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .moves = {MOVE_SWORDS_DANCE, MOVE_PLAY_ROUGH, MOVE_IRON_HEAD, MOVE_MACH_PUNCH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_FryRoute110[] = {
    {
    .iv = 255,
    .lvl = 20,
    .species = SPECIES_LINOONE,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_ROCK_SMASH, MOVE_HEADBUTT, MOVE_GROWL, MOVE_PROTECT}
    },
    {
    .iv = 255,
    .lvl = 19,
    ...
    .abilityNums = 0,
    .evs = {0, 252, 0, 0, 0, 252},
    .moves = {MOVE_ICE_BEAM, MOVE_WATER_PULSE, MOVE_CRUNCH, MOVE_TRIGGER}
    },
   {
    .iv = 255,
    .lvl = 22,
    ...
    .moves = {MOVE_REVENGE, MOVE_CONFUSION, MOVE_DISARMING_VOICE, MOVE_COTTON_GUARD}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .iv = 100,
    .lvl = 54,
    .species = SPECIES_MOTHERFUCK,
    .moves = {MOVE_SPORE, MOVE_PERISH_SONG, MOVE_DESTINY_BOND, MOVE_EXPLOSION}
    },
    {
    .iv = 100,
    .lvl = 54,
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .lvl = 56,
    .species = SPECIES_SYLVEON,
    .moves = {MOVE_IRON_DEFENSE, MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_DARK_PULSE}
    },
    {
    .iv = 100,
    .lvl = 57,
    .species = SPECIES_SJWHALE,
    .moves = {MOVE_BELLY_DRUM, MOVE_CRUNCH, MOVE_TRIGGER, MOVE_LIQUIDATION}
    },
    {
    .iv = 100,
    .lvl = 57,
    .species = SPECIES_EMPOLEON,
    .moves = {MOVE_SURF, MOVE_DAZZLING_GLEAM, MOVE_FLASH_CANNON, MOVE_NONE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Tate2[] = {
{
    .iv = 255,
    .lvl = 80,
    .species = SPECIES_CLAYDOL,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Matteo[] = {
    {
    .iv = 0,
    .lvl = 36,
    .species = SPECIES_CARVANHA,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Seymour[] = {
    {
    .iv = 100,
    .lvl = 22,
...
static const struct TrainerMonItemCustomMoves sParty_FryMossdeep[] = {
{
    .iv = 255,
    .lvl = 43,
    .species = SPECIES_OBSTAGOON,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_THROAT_CHOP, MOVE_PSYCHIC_FANGS, MOVE_SCREECH, MOVE_OBSTRUCT}
    },
    {
    .iv = 255,
    .lvl = 43,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_PIN_MISSILE, MOVE_ICICLE_SPEAR}
    },
    {
    .iv = 255,
    .lvl = 45,
    ...
    .abilityNums = 0,
    .evs = {0, 252, 0, 0, 0, 252},
    .moves = {MOVE_STOMP, MOVE_CRUNCH, MOVE_AQUA_JET, MOVE_TRIGGER}
    },
    {
    .iv = 255,
    .lvl = 46,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_HEAT_CRASH, MOVE_IRON_HEAD, MOVE_SHARPEN, MOVE_ZEN_HEADBUTT}
    },
    {
    .iv = 255,
    .lvl = 48,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_CLOSE_COMBAT, MOVE_MOONBLAST, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Beau[] = {
    ...
    .lvl = 37,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_PSYBEAM, MOVE_CHAOS_DUNK}
    },
    {
    .iv = 0,
    .lvl = 37,
    ...
    .lvl = 37,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_RAPID_SPIN, MOVE_MUD_SLAP, MOVE_PSYCHIC, MOVE_CHAOS_DUNK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Tumblrita[] = {
    {
    .iv = 255,
    .lvl = 66,
    .species = SPECIES_SJWHALE,
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_TRIGGER, MOVE_CRUNCH, MOVE_LIQUIDATION, MOVE_LEECH_LIFE}
    },
    {
    .iv = 255,
    .lvl = 67,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_SKY_DROP, MOVE_CHAOS_DUNK, MOVE_DESTINY_BOND}
    },
    {
    .iv = 255,
    .lvl = 68,
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_LIQUIDATION, MOVE_PLAY_ROUGH, MOVE_SUPERPOWER, MOVE_CHARM}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .abilityNums = 2,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_EARTHQUAKE, MOVE_SURF, MOVE_TOXIC, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 71,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_TRIGGER, MOVE_CRUNCH, MOVE_LIQUIDATION, MOVE_ICE_BEAM}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Floyd[] = {
    {
    .iv = 255,
    .lvl = 68,
    .species = SPECIES_GLASSANNON,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_ICE_BEAM, MOVE_FLASH_CANNON, MOVE_EARTHQUAKE, MOVE_CHAOS_DUNK}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLY, MOVE_ICE_BEAM, MOVE_EARTHQUAKE, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 70,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_EARTHQUAKE, MOVE_FREEZE_DRY, MOVE_THRASH, MOVE_SPEED_WEED}
    },
    {
    .iv = 255,
    .lvl = 71,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_CONFUSE_RAY, MOVE_MACH_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_ICICLE_CRASH, MOVE_FOUL_PLAY, MOVE_X_SCISSOR, MOVE_CHAOS_DUNK}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_AQUA_JET}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Joy[] = {
    {
    .iv = 255,
    .lvl = 70,
    ...
    .abilityNums = 0,
    .evs = {252, 0, 0, 6, 0, 252},
    .moves = {MOVE_THUNDERBOLT, MOVE_BADDY_BAD, MOVE_FLASH_CANNON, MOVE_SPIKES}
    },
    {
    .iv = 255,
    .lvl = 71,
    ...
    .abilityNums = 2,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_SURF, MOVE_FLASH_CANNON, MOVE_SPORE, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_VENOWATT,
    ...
    .iv = 255,
    .lvl = 72,
    .species = SPECIES_HOUNDOOM, //could probably replace too
    .heldItem = ITEM_SHUCA_BERRY,
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_SWORDS_DANCE, MOVE_FIRE_FANG, MOVE_CRUNCH, MOVE_ICE_FANG}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .abilityNums = 0,
    .evs = {76, 0, 0, 180, 0, 252},
    .moves = {MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_SHADOW_BALL, MOVE_NASTY_PLOT}
    }
};

static const struct TrainerMonItemCustomMoves sParty_Snoop[] = {
    {
    .iv = 255,
    .lvl = 71,
    ...
    .moves = {MOVE_SPORE, MOVE_SOLAR_BEAM, MOVE_SYNTHESIS, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 255,
    .lvl = 74,
    .species = SPECIES_PHANTASH,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FISHIOUS_REND, MOVE_CRUNCH, MOVE_DRAGON_HAMMER, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 77,
    ...
    .abilityNums = 2,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_OVERHEAT, MOVE_GIGA_DRAIN, MOVE_SHELL_SMASH, MOVE_DRACO_METEOR}
    }
};

static const struct TrainerMonItemCustomMoves sParty_FryEverGrande[] = { //Fry after beating Elite Four Snoop. FRY_EVER_GRANDE
    {
    .iv = 255,
    .lvl = 68,
    .species = SPECIES_OBSTAGOON,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 0, 252, 252},
    .moves = {MOVE_SEED_FLARE, MOVE_SYNTHESIS, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 255,
    .lvl = 71,
    ...
    .abilityNums = 0,
    .evs = {0, 252, 0, 0, 0, 252},
    .moves = {MOVE_CRUNCH, MOVE_LIQUIDATION, MOVE_SLACK_OFF, MOVE_TRIGGER}
    },
    {
    .iv = 255,
    .lvl = 72,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_HEAT_CRASH, MOVE_IRON_HEAD, MOVE_SHARPEN, MOVE_SPEED_WEED}
    },
    {
    .iv = 255,
    .lvl = 73,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLY, MOVE_OUTRAGE, MOVE_FLAMETHROWER, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 74,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_CLOSE_COMBAT, MOVE_MOONBLAST, MOVE_CRUNCH, MOVE_BEHEMOTH_BASH}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cynthia[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 0, 252, 0, 252, 0},
    .moves = {MOVE_SHADOW_BALL, MOVE_DARK_PULSE, MOVE_PSYCHIC, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 82,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_RECOVER, MOVE_MIRROR_COAT, MOVE_SCALD, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 82,
    ...
    .abilityNums = 1,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_ENERGY_BALL, MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_DAZZLING_GLEAM}
    },
    {
    .iv = 255,
    .lvl = 83,
    ...
    .abilityNums = 2,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FLAME_CHARGE, MOVE_SPEED_WEED, MOVE_SHELL_SMASH, MOVE_ACID}
    },
    {
    .iv = 200,
    .lvl = 14,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_BLOCK, MOVE_HARDEN, MOVE_ICE_SHARD, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_KARATE_CHOP, MOVE_BITE, MOVE_THUNDER_FANG, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 18,
    ...
    .heldItem = ITEM_CHARCOAL,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FLAME_CHARGE, MOVE_SAND_ATTACK, MOVE_MACH_PUNCH, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 19,
    ...
    .heldItem = ITEM_EVIOLITE,
    .evs = {252, 0, 3, 0, 3, 252},
    .moves = {MOVE_REVENGE, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 100,
    .lvl = 18,
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_THUNDER_SHOCK, MOVE_BITE, MOVE_WORK_UP, MOVE_TRIGGER}
    },
    {
    .iv = 200,
    .lvl = 20,
    ...
    .heldItem = ITEM_WATMEL_BERRY,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FURY_CUTTER, MOVE_VITAL_THROW, MOVE_AURORA_BEAM, MOVE_BULK_UP}
    }
};

static const struct TrainerMonItemCustomMoves sParty_BillNye1[] = {
    {
    .iv = 200,
    .lvl = 22,
    .species = SPECIES_VOLTORB,
    ...
    .abilityNums = 2,
    .evs = {0, 0, 0, 252, 0, 252},
    .moves = {MOVE_SHOCK_WAVE, MOVE_SPEED_WEED, MOVE_SWIFT, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 200,
    .lvl = 23,
    ...
    .abilityNums = 2,
    .evs = {252, 0, 0, 0, 0, 252},
    .moves = {MOVE_SHOCK_WAVE, MOVE_FLAME_CHARGE, MOVE_THUNDER_WAVE, MOVE_PURSUIT}
    },
    {
    .iv = 220,
    .lvl = 25,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_AURORA_BEAM, MOVE_BULLET_PUNCH, MOVE_THUNDER_WAVE, MOVE_SCREECH}
    },
    {
    .iv = 220,
    .lvl = 24,
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_AQUA_JET, MOVE_SPARK, MOVE_SCARY_FACE, MOVE_BITE}
    },
    {
    .iv = 255,
    .lvl = 26,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_HEX, MOVE_THUNDER_WAVE, MOVE_CONFUSE_RAY, MOVE_DRAINING_KISS}
    }
};
//https://github.com/pret/pokeemerald/wiki/Make-Norman%27s-Slaking-Have-Ability-Intimidate
static const struct TrainerMonItemCustomMoves sParty_Molly1[] = {
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_LIZAKBAR,
    ...
    .abilityNums = 0,
    .evs = {0, 0, 129, 0, 129, 252},
    .moves = {MOVE_HOLY_DUTY_CPU, MOVE_HOLY_DUTY, MOVE_NONE, MOVE_NONE}
    },
    {
    .iv = 255,
    .lvl = 33,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_LAVA_PLUME, MOVE_GIGA_DRAIN, MOVE_HYPER_VOICE, MOVE_WILL_O_WISP}
    },
    {
    .iv = 255,
    .lvl = 34,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_HEAT_CRASH, MOVE_IRON_HEAD, MOVE_SPEED_WEED, MOVE_SHARPEN}
    },
        {
    .iv = 255,
    .lvl = 35,
    .species = SPECIES_FLORIGRACE,
    .heldItem = ITEM_MYSTIC_WATER,
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_SPORE, MOVE_ICY_WIND, MOVE_BUBBLE_BEAM, MOVE_GIGA_DRAIN}
    },
    {
    .iv = 255,
    .lvl = 36,
    ...
    .abilityNums = 2,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FIRE_LASH, MOVE_PSYCHIC_FANGS, MOVE_TRAILBLAZE, MOVE_SPORE}
    },
    {
    .iv = 255,
    .lvl = 37,
    ...
    .abilityNums = 1,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLAME_BURST, MOVE_GIGA_DRAIN, MOVE_SHELL_SMASH, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 0, 252, 0, 252, 0},
    .moves = {MOVE_SOFT_BOILED, MOVE_TOXIC, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_PSYCHIC_FANGS, MOVE_FACADE, MOVE_EARTHQUAKE, MOVE_NIGHT_SLASH}
    },
    {
    .iv = 255,
    .lvl = 38,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_TOXIC, MOVE_DOUBLE_EDGE, MOVE_COTTON_GUARD, MOVE_PSYCHIC_FANGS}
    },
    {
    .iv = 255,
    .lvl = 39,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_THROAT_CHOP, MOVE_BELLY_DRUM, MOVE_RECOVER, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 40,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_REVERSAL, MOVE_YAWN, MOVE_FACADE, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 41,
    .species = SPECIES_ADESIGN,
    .heldItem = ITEM_WISE_GLASSES,
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_AN_ATTACK, MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_PSYCHIC}
    },
};
...
static const struct TrainerMonItemCustomMoves sParty_Ned1[] = {
   {
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_BRAVE_BIRD, MOVE_SPORE, MOVE_POISON_JAB, MOVE_EARTHQUAKE}
    },
    {
    .iv = 255,
    .lvl = 49,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_EARTHQUAKE, MOVE_BRAVE_BIRD, MOVE_IRON_HEAD, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 50,
...
static const struct TrainerMonItemCustomMoves sParty_Bender1[] = {
    {
    .iv = 255,
    .lvl = 61,
    .species = SPECIES_EMPOLEON,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_SURF, MOVE_FLASH_CANNON, MOVE_EARTH_POWER, MOVE_NASTY_PLOT}
    },
    {
    .iv = 255,
    .lvl = 62,
    .species = SPECIES_MOZZAMAZEL,
    .heldItem = ITEM_LIFE_ORB,
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_GIGA_DRAIN, MOVE_FLAMETHROWER, MOVE_EARTH_POWER}
    },
    {
    .iv = 255,
    .lvl = 63,
    ...
    .abilityNums = 0,
    .evs = {252, 0, 3, 0, 3, 252},
    .moves = {MOVE_SPORE, MOVE_PERISH_SONG, MOVE_DESTINY_BOND, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 64,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_MOONBLAST, MOVE_BABY_DOLL_EYES, MOVE_EARTH_POWER, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 67,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_EARTHQUAKE, MOVE_PLAY_ROUGH, MOVE_DOUBLE_TEAM, MOVE_BEHEMOTH_BLADE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_JoyRoute121[] = {
    {
    .iv = 200,
    .lvl = 50,
    .species = SPECIES_EMPOLEON,
    .moves = {MOVE_FLASH_CANNON, MOVE_SURF, MOVE_THUNDERBOLT, MOVE_CALM_MIND}
    },
    {
    .iv = 200,
    .lvl = 50,
    ...
    .abilityNums = 0,
    .evs = {0, 0, 0, 252, 0, 252},
    .moves = {MOVE_PIN_MISSILE, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_CALM_MIND}
    },
    {
    .iv = 200,
    .lvl = 51,
    .species = SPECIES_MEW,
    .moves = {MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_CRUNCH, MOVE_NASTY_PLOT}
    },
    {
    .iv = 200,
    .lvl = 51,
    .species = SPECIES_URSWINE,
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_CRUNCH, MOVE_OUTRAGE, MOVE_FIRE_LASH, MOVE_TRAILBLAZE}
    },
    {
    .iv = 200,
    .lvl = 52,
    ...
    .abilityNums = 0,
    .evs = {252, 0, 0, 6, 0, 252},
    .moves = {MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_BABY_DOLL_EYES, MOVE_AGILITY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Josh[] = {
    ...
    .lvl = 12,
    .species = SPECIES_SOLROCK,
    .moves = {MOVE_CONFUSION, MOVE_ROCK_TOMB, MOVE_NONE, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Tommy[] = {
    ...
    .lvl = 10,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_TACKLE, MOVE_ROLLOUT, MOVE_UPROAR, MOVE_NONE}
    },
    {
    .iv = 120,
    .lvl = 10,
    .species = SPECIES_GEODUDE,
    .moves = {MOVE_TACKLE, MOVE_ROCK_TOMB, MOVE_EXPLOSION, MOVE_NONE}
    },
    {
    .iv = 150,
    .lvl = 10,
    .species = SPECIES_BONGECKO,
    .moves = {MOVE_SPEED_WEED, MOVE_FLAME_CHARGE, MOVE_WATER_GUN, MOVE_NONE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Katelynn[] = {
    ...
    .lvl = 59,
    .species = SPECIES_GARCHOMP,
    .moves = {MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_DRAGON_CLAW, MOVE_HONE_CLAWS}
    }
};
...
static const struct TrainerMonItemDefaultMoves sParty_WLC1[] = {
    {
    .iv = 0,
    .lvl = 15,
    .species = SPECIES_LUXIO,
...
static const struct TrainerMonItemDefaultMoves sParty_WLC2[] = {
    {
    .iv = 150,
    .lvl = 55,
    .species = SPECIES_CAROLINE,
...
static const struct TrainerMonItemCustomMoves sParty_Dianne[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_PSYCHIC, MOVE_SURF}
    },
    {
    .iv = 0,
    .lvl = 58,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_THUNDERBOLT, MOVE_EARTHQUAKE, MOVE_SURF, MOVE_SYNTHESIS}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_FrySkyPillar[] = {
    {
    .iv = 255,
    .lvl = 60,
    .species = SPECIES_OBSTAGOON,
    ...
    .abilityNums = 0,
    .evs = {0, 0, 129, 0, 129, 252},
    .moves = {MOVE_WISH, MOVE_PROTECT, MOVE_PSYCHIC, MOVE_FLASH_CANNON}
    },
    {
    .iv = 255,
    .lvl = 60,
    ...
    .abilityNums = 0,
    .evs = {0, 129, 0, 129, 0, 252},
    .moves = {MOVE_BLIZZARD, MOVE_WOOD_HAMMER, MOVE_EARTHQUAKE, MOVE_TRIGGER}
    },
    {
    .iv = 255,
    .lvl = 62,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FLY, MOVE_OUTRAGE, MOVE_REST, MOVE_EXTREME_SPEED}
    },
    {
    .iv = 255,
    .lvl = 65,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Alice2[] = {
    {
    .iv = 50,
    .lvl = 60,
    .species = SPECIES_FISHNISM,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Midori[] = {
    {
    .iv = 0,
    .lvl = 59,
    .species = SPECIES_AZUMARILL,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Ella[] = {
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_MACHOP,
...
static const struct TrainerMonNoItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 55,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_SPORE, MOVE_NIGHT_SLASH, MOVE_CHARM, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 150,
    .lvl = 57,
    ...
    .lvl = 52,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_TRI_ATTACK, MOVE_METAL_SOUND}
    },
    {
    .iv = 150,
    .lvl = 55,
    .species = SPECIES_MARLEYZARD,
    .moves = {MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_ENERGY_BALL, MOVE_SHELL_SMASH}
    },
    {
    .iv = 255,
    .lvl = 57,
...
static const struct TrainerMonItemCustomMoves sParty_FryRoute104[] = {
    {
    .iv = 255,
    .lvl = 9,
    .species = SPECIES_ZIGZAGOON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_HOWL, MOVE_ROCK_SMASH, MOVE_PIN_MISSILE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Gerald[] = {
    ...
    .lvl = 30,
    .species = SPECIES_CHARMELEON,
    .moves = {MOVE_FLAMETHROWER, MOVE_AERIAL_ACE, MOVE_AGILITY, MOVE_NIGHT_SLASH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Danielle[] = {
    ...
    .lvl = 34,
    .species = SPECIES_MARIGUANA,
    .moves = {MOVE_SPEED_WEED, MOVE_BRICK_BREAK, MOVE_CONFUSION, MOVE_FIRE_PUNCH}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 29,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_GROWTH, MOVE_STUN_SPORE, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED}
    },
    {
    .iv = 0,
    .lvl = 31,
...
static const struct TrainerMonNoItemCustomMoves sParty_MelAndPaul[] = {
    ...
    .lvl = 37,
    .species = SPECIES_SPRUCIFIX,
    .moves = {MOVE_WOOD_HAMMER, MOVE_TRIGGER, MOVE_SYNTHESIS, MOVE_PHANTOM_FORCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .heldItem = ITEM_MIRACLE_SEED,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_FLAME_CHARGE, MOVE_SPEED_WEED, MOVE_AQUA_JET, MOVE_AGILITY}
    },
    {
    .iv = 200,
    .lvl = 100,
    ...
    .heldItem = ITEM_PASSHO_BERRY,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_BLOCK, MOVE_HARDEN, MOVE_ICICLE_CRASH, MOVE_CHAOS_DUNK}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_CLOSE_COMBAT, MOVE_CRUNCH, MOVE_WORK_UP, MOVE_TRIGGER}
    },
    {
    .iv = 200,
    .lvl = 100,
    ...
    .lvlmodifier = 4,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_X_SCISSOR, MOVE_VITAL_THROW, MOVE_AURORA_BEAM, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = {
    ...
    .abilityNums = 1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_LIQUIDATION, MOVE_CRUNCH, MOVE_WORK_UP, MOVE_TRIGGER}
    },
    {
    .iv = 100,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_BillNye2[] = {
    {
    .iv = 200,
    .lvl = 100,
    .species = SPECIES_ELECTRODE,
    ...
    .lvlmodifier = -1,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_CHAOS_DUNK, MOVE_THUNDERBOLT, MOVE_SPEED_WEED, MOVE_SHOCK_WAVE}
    },
    {
    .iv = 220,
    .lvl = 100,
    ...
    .lvlmodifier = 2,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_HEX, MOVE_THUNDER_WAVE, MOVE_CONFUSE_RAY, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = {
    ...
    .heldItem = ITEM_SHUCA_BERRY,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_THUNDERBOLT, MOVE_SCARY_FACE, MOVE_SPEED_WEED, MOVE_CONFUSION}
    },
    {
    .iv = 220,
    .lvl = 100,
    ...
    .heldItem = ITEM_ZAP_PLATE,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_AQUA_JET, MOVE_THUNDERBOLT, MOVE_SCARY_FACE, MOVE_BITE}
    },
    {
    .iv = 220,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Molly2[] = {
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_LIZAKBAR,
    ...
    .lvlmodifier = 0,
    .evs = {0, 0, 0, 0, 252, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_NASTY_PLOT, MOVE_DARK_PULSE, MOVE_SOLAR_BEAM}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .lvlmodifier = 1,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_SCALD, MOVE_SOLAR_BEAM, MOVE_SCARY_FACE}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .abilityNums = 0,
    .evs = {6, 0, 0, 252, 0, 252},
    .moves = {MOVE_FLAMETHROWER, MOVE_GIGA_DRAIN, MOVE_SHELL_SMASH, MOVE_DRAGON_PULSE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_THROAT_CHOP, MOVE_BELLY_DRUM, MOVE_SOFT_BOILED, MOVE_IRON_HEAD}
    },
    {
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Norman3[] = {
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_BOOMBURST, MOVE_PSYCHIC, MOVE_FLAMETHROWER, MOVE_SWORDS_DANCE}
    },
    {
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemCustomMoves sParty_Liza2[] = {
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_CLAYDOL,
...
static const struct TrainerMonItemCustomMoves sParty_Bender2[] = {
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_EMPOLEON,
    ...
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_DRAGKING,
    .heldItem = ITEM_MUSCLE_BAND,
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_PLAY_ROUGH, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_WORK_UP}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .abilityNums = 0,
    .evs = {6, 252, 0, 0, 0, 252},
    .moves = {MOVE_EARTHQUAKE, MOVE_PLAY_ROUGH, MOVE_MINIMIZE, MOVE_BEHEMOTH_BLADE}
    }
};

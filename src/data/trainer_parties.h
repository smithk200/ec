...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HIGH_JUMP_KICK, MOVE_SCARY_FACE, MOVE_SAND_ATTACK, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 63,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .moves = {MOVE_THUNDERBOLT, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_SHEER_COLD}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .moves = {MOVE_LEAF_STORM, MOVE_BRAVE_BIRD, MOVE_DRAGON_DANCE, MOVE_AERIAL_ACE}
    },
    {
    .iv = 250,
    .lvl = 69,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .heldItem = ITEM_MYSTIC_WATER,
    .abilityNums = 0,
    .moves = {MOVE_SPORE, MOVE_SYNTHESIS, MOVE_SURF, MOVE_MEGA_DRAIN}
    },
    {
    .iv = 250,
    .lvl = 33,
    ...
    .heldItem = ITEM_AIR_BALLOON,
    .abilityNums = 0,
    .moves = {MOVE_HEAT_CRASH, MOVE_IRON_HEAD, MOVE_SUPERPOWER, MOVE_SHARPEN}
    },
    {
    .iv = 250,
    .lvl = 35,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .abilityNums = 0,
    .moves = {MOVE_OVERHEAT, MOVE_EXTREME_SPEED, MOVE_GIGA_DRAIN, MOVE_SPORE}
    },
    {
    .iv = 250,
    .lvl = 36,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .heldItem = ITEM_NONE,
    .abilityNums = 0,
    .moves = {MOVE_STUN_SPORE, MOVE_FACADE, MOVE_TOXIC, MOVE_FEINT_ATTACK}
    },
    {
    .iv = 200,
    .lvl = 39,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .abilityNums = 0,
    .moves = {MOVE_BRAVE_BIRD, MOVE_SPORE, MOVE_POISON_JAB, MOVE_TOXIC}
    },
    {
    .iv = 210,
    .lvl = 48,
    ...
    .abilityNums = 0,
    .moves = {MOVE_EARTHQUAKE, MOVE_BRAVE_BIRD, MOVE_STEEL_WING, MOVE_FLAMETHROWER}
    },
    {
    .iv = 255,
    .lvl = 46,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .abilityNums = 0,
    .moves = {MOVE_SURF, MOVE_FLASH_CANNON, MOVE_SWEET_KISS, MOVE_FLAIL}
    },
    {
    .iv = 200,
    .lvl = 56,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_OBLIVION_WING, MOVE_EARTH_POWER, MOVE_FLAMETHROWER}
    },
    {
    .iv = 200,
    .lvl = 59,

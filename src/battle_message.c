...
static const u8 sText_TeamGainedExp[] = _("The rest of the team gained some\nExp. Points thanks to the Exp. Share!\p");
...
static const u8 sText_ItemLimitHasBeenReached[] = _("Four items have already been used\nin battle!");
...
static const u8 sText_PkmnCutsAttackWith[] = _("{B_DEF_NAME_WITH_PREFIX}'s Attack fell!");
...
static const u8 sText_MirrorMoveFailed[] = _("The Miiror Move failed!");
...
static const u8 sText_Someones[] = _("{B_PLAYER_NAME}'s");
...
static const u8 sText_SuperStartBegin[] = _("{B_ATK_NAME_WITH_PREFIX} is waiting\npatiently!");
static const u8 sText_SuperStartEnd[] = _("{B_ATK_NAME_WITH_PREFIX} started\ngetting powerful!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_SUPERSTARTEND - BATTLESTRINGS_TABLE_START] = sText_SuperStartEnd,
    [STRINGID_SUPERSTARTBEGIN - BATTLESTRINGS_TABLE_START] = sText_SuperStartBegin,
};
...
const u16 gSwitchInAbilityStringIds[] =
{
    ...
    [B_MSG_SWITCHIN_SUPERSTART] = STRINGID_SUPERSTARTBEGIN,
};
